...
trait JScrollBarReactiveProxy extends JComponentReactiveProxy  {
  override def peer: javax.swing.JScrollBar
  private[JScrollBarReactiveProxy] lazy val outer = peer

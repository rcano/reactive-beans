...
trait JTextFieldReactiveProxy extends JTextComponentReactiveProxy  {
  override def peer: javax.swing.JTextField
  private[JTextFieldReactiveProxy] lazy val outer = peer

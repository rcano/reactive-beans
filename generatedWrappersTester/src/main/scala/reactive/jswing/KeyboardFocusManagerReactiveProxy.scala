...
trait KeyboardFocusManagerReactiveProxy extends Observing {
  def peer: java.awt.KeyboardFocusManager
  private[KeyboardFocusManagerReactiveProxy] lazy val outer = peer
  trait Signals {

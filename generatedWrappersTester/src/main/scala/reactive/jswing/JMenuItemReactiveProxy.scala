...
trait JMenuItemReactiveProxy extends AbstractButtonReactiveProxy  {
  override def peer: javax.swing.JMenuItem
  private[JMenuItemReactiveProxy] lazy val outer = peer

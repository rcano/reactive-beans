...
trait CellRendererPaneReactiveProxy extends ContainerReactiveProxy  {
  override def peer: javax.swing.CellRendererPane
  private[CellRendererPaneReactiveProxy] lazy val outer = peer

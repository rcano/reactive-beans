...
trait AbstractListModelReactiveProxy[E <: java.lang.Object] extends Observing {
  def peer: javax.swing.AbstractListModel[E]
  private[AbstractListModelReactiveProxy] lazy val outer = peer

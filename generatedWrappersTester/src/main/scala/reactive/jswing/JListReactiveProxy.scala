...
trait JListReactiveProxy[E <: java.lang.Object] extends JComponentReactiveProxy  {
  override def peer: javax.swing.JList[E]
  private[JListReactiveProxy] lazy val outer = peer

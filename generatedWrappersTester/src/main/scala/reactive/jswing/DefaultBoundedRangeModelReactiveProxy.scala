...
trait DefaultBoundedRangeModelReactiveProxy extends Observing {
  def peer: javax.swing.DefaultBoundedRangeModel
  private[DefaultBoundedRangeModelReactiveProxy] lazy val outer = peer

...
trait JSeparatorReactiveProxy extends JComponentReactiveProxy  {
  override def peer: javax.swing.JSeparator
  private[JSeparatorReactiveProxy] lazy val outer = peer

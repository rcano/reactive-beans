...
trait JFormattedTextFieldReactiveProxy extends JTextFieldReactiveProxy  {
  override def peer: javax.swing.JFormattedTextField
  private[JFormattedTextFieldReactiveProxy] lazy val outer = peer
